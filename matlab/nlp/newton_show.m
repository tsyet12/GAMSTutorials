function [xmin,fmin,evals,epsilo] = newton_show(x,epsil,minx,maxx,stepx,miny,maxy,stepy,lines,f,nablaf,hessianf,varargin)
% (c) jskl UoM
%
...
% Example use:
%
% [xmin,fmin,evals,epsilo] = newton_show([-2 2]',1e-9,-2,2,0.05,-2,2,0.05,25,'ex_grad','nabla_ex_grad','H_ex_grad',2,4,3)
%
...
%
% Try also:
% [xmin,fmin,evals,epsilo] = newton_show([0 3]',1e-5,0,3.5,0.05,-1,3.1,0.05,40,'ex_cycBS','nabla_ex_cycBS','H_ex_cycBS')
% [xmin,fmin,evals,epsilo] = newton_show([-2 2]',1e-5,-2.2,2,0.05,-8,5,0.05,40,'banana','nabla_banana','H_banana')
%
evals = 0;
