function [xmin,fmin,evals,epsilo] = cyclic_show(x,epsil,minx,maxx,stepx,miny,maxy,stepy,lines,f,varargin)
% (c) jskl UoM
%
% cyclic_show(x,epsil,minx,maxx,stepx,miny,maxy,stepy,lines,f,varargin)
% finds a minimum of a bivariate scalar function by using the cyclic
% co-ordinate algorithm. Search steps are shown on function contours.
%
...
% Example use:
%
% [xmin,fmin,evals,epsilo] = cyclic_show([-2 1]',1e-9,-2,2,0.05,-2,2,0.05,25,'ex_cyc',2,4,3)
%
...
%
% Try also:
% [xmin,fmin,evals,epsilo] = cyclic_show([0 3]',1e-5,0,3.5,0.05,0,3.1,0.05,40,'ex_cycBS')
% [xmin,fmin,evals,epsilo] = cyclic_show([-2 2]',1e-5,-2,2,0.05,-1,3,0.05,40,'banana')
%
[xmin,fmin,evals,epsilo] = cyclic_show([-2 1]',1e-9,-2,2,0.05,-2,2,0.05,25,'ex_cyc',2,4,3)
